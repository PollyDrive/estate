...
• Выбирать 6 групп из списка (те, что давно не скрейпились)
• Скрейпить до 15 постов из каждой группы
• Фильтровать по stop_words в заголовке
• Фильтровать по stop_locations в локации
• Сохранять кандидатов со статусом stage1 и source='facebook_group'
